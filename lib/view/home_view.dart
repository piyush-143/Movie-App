...
import 'package:quadb_test_app/view/search_view.dart';
    ...
    return Scaffold(
      ...
      body: FutureBuilder(
        ...
        builder: (context, AsyncSnapshot snapshot) =>
            Consumer<MovieViewModel>(builder: (context, value, child) {
                            ...
                            Navigator.push(
                              ...
                              MaterialPageRoute(
                                builder: (context) => SelectedMovieDetailView(
                                    name: value.movieList.data![index].show!.name
                                        .toString(),
                                    summary: value
                                        .movieList.data![index].show!.summary
                                        .toString(),
                                    image: value.movieList.data![index].show?.image?.original != null
                                    ...
                                    officialSite: value.movieList.data![index]
                                        ...
                                        .toString(),
                                    premiered:
                                        value.movieList.data![index].show!.premiered.toString()),
                              ),
                            );
                          },
                          child: Container(
                                  ...
                                  MaterialPageRoute(
                                    builder: (context) => SelectedMovieDetailView(
                                        ...
                                        officialSite: value.movieList
                                            ...
                                            .toString(),
                                        premiered: value.movieList.data![index].show!.premiered.toString()),
                                  ),
                                );
                              },
                              child: Container(
